...
public class LoginServiceImpl implements UserDetailsService, LoginService {
	...
	/**
	 * Carga el UserDetails con el user name y la contrase�a es comparada
	 * internamente con Spring-Security
	 */
	@Override
	...
	/**
	 * Genera el usuario, con los permisos y password para ser comparado por spring
	 * security
	 * 
	 * @param uUser
	 * @param boolToken
